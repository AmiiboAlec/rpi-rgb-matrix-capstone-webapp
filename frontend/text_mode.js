...
class text extends preview {
    constructor(width, height, text_area) {
        ...
        for (let i = 0; i < this.rows; i++) {
            ...
            text_row.onchange = () => {
                ...
                this.background_color[i] = new Array(this.text[i].length);
    ...
    toString() {
        ...
        for (let i = 0; i < this.rows; i++) {
            ...
            let color_string_array1 = [];
            let color_string_array2 = [];
    ...
    draw_row(row) {
        ...
        let draw_column = (start, bitmap, foreground_color, bg_color) => {
            ...
            for (let i = 0; i < text_height; i++) {
                ...
                if (is_pixel_on) {
                    ...
                    this.update_pixel(x, y + i, bg_color);
            }
        };
